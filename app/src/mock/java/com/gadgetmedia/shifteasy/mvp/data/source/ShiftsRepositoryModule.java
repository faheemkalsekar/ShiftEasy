...
import com.gadgetmedia.shifteasy.mvp.data.FakeRemoteDataSource;
...
abstract public class ShiftsRepositoryModule {
    ...
    @Binds
    @Remote
    abstract ShiftsDataSource provideShiftsRemoteDataSource(final FakeRemoteDataSource dataSource);
}
